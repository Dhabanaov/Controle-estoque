...
begin
  ...
  Q_pesq_padrao.SQL.Add('SELECT A.ID_PRODUTO, ' + 'A.PRODUTO_DESCRICAO,' +
    'A.VL_CUSTO,         ' + 'A.ESTOQUE,          ' + 'A.ESTOQUE_MIN,      ' +
    'A.UNIDADE,          ' + 'A.ID_FORNECEDOR,    ' + 'B.NOME,             ' +
...
procedure TFrm_Pesq_Produtos.bt_transferirClick(Sender: TObject);
begin
  inherited;
...
procedure TFrm_Pesq_Produtos.DBGrid1DblClick(Sender: TObject);
begin
  inherited;
 bt_transferir.Click;
end;
